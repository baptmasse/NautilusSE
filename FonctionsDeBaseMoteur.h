...
class FonctionsDeBaseMoteur
{
    public:
        ...
        void GererInclinaison(double AngleTangage, double AngleRoulis, double VitesseProf);

        void Correction(double VitesseConsigne, double VitesseReelle, bool SensVit, bool SensDeRotation, double Cap, double ProfondeurConsigne, double ProfondeurReelle, bool SensProf);
    ...
    private:
        ...
        PID Correcteur; //Correcteur PID

        CJY901 *Centrale_Inertielle = 0; //Pointeur qui sera dirigé sur la centrale inertielle
};
