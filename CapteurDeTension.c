float VoltageArduino; //Tension de sortie captée par la carte arduino --> nombre entre 0 et 1023
int Vcc=5; //tension d'alimentation de l'arduino (ATTENTION : 5 * Vccmax >= VBatterie)
float Vbatterie; // tension réelle de la batterie
...
void loop ()
{
  ...
  Vbatterie=factor*Vcc*VoltageArduino/1023; // pont diviseur de tension
